...
# source internal functions and settings

data_path <- '~/cloud/gdrive/fire_project/local_data/analysis4/'
fig_path <- '~/cloud/gdrive/fire_project/postfire_regen/analysis4/figs/'
...
adams_theme <- theme(plot.title = element_text(hjust = 0.5, size = title_size),
                     ...
                     legend.title = element_text(size = axis_size),
