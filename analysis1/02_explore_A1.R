source('analysis1/02_clean_analysis_data.R')
...
getCorrelationMatrix(d = df4,varsForCorr = c("recoveryTime","slope","elevation","hli","AEThist","postFireSAP","pptYr1_3_annual_mean","burnSev"))
