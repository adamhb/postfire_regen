...
#Jan 11, 2023
#AHB identified the input and output files of this script and moved them into a folder
#called /home/adam/cloud/gdrive/fire_project/local_data/analysis1

#AHB did not run this script, but assumes that when this script starts with 
# FA_3_30_2022.csv and FA_3_31_2022.csv
# it produces
# analysisReadyDF_4_1_2022.csv
# This will need to be checked if we go with this script in the final analysis

end_recovery_period <- 2019
rollingMeanLength  <- 3 #years

source('analysis1/00_setup_A1.R')
#source('00_clean.R')
...
write_csv(export,paste0(data_path,'analysisReadyDF_4_1_2022.csv'))
