...
makePDF(fig = TwoD_vars_NF,file_name = "2D_vars_NF_MINPRECIP", width = 12, height = 8,units = "in")
makePNG(fig = TwoD_vars_NF,file_name = "2D_vars_NF_MINPRECIP", width = 11, height = 7, units = "in")
...
NF_Minprecip_interaction_fig <- plot_interaction(x_var = "postFireMaxT",
                                       y_var = "minPostFirePrecip",
                                       x_axis_label = "Mean daily max temperture [°C] \n of first 3 post-fire years",
                                       y_axis_label = "Min precipitation [mm yr-1] \n of first 3 post-fire years",
                                       x_min = 12,y_min = 300,
                                       x_max = 24,y_max = 2000,
                                       bin_width = 0.01)

NF_Minprecip_interaction_fig


makePDF(fig = NF_Minprecip_interaction_fig,file_name = "NF_MINPRECIP_interaction", width = 8, height = 6,units = "in")
makePNG(fig = NF_Minprecip_interaction_fig,file_name = "NF_MINPRECIP_interaction", width = 8, height = 6,units = "in")
